...
import { CurrencyAmount, sqrt, Token, Price, TradeType, Fraction, computePriceImpact, sortedInsert, validateAndParseAddress } from '@dreamswap/sdk-core';
...
var Pair = /*#__PURE__*/function () {
  function Pair(currencyAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].currency.chainId, Pair.getAddress(tokenAmounts[0].currency, tokenAmounts[1].currency), 18, 'DREAM', 'DREAMSWAP');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Dreamswap V2 Router, and has static methods for helping execute trades.
 */
